...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        openFile->setGeometry(QRect(130, 80, 121, 51));
        sendBtn = new QPushButton(centralWidget);
        sendBtn->setObjectName(QStringLiteral("sendBtn"));
        sendBtn->setGeometry(QRect(130, 160, 121, 51));
        label = new QLabel(centralWidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(150, 30, 91, 16));
        QFont font;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "SENDER", nullptr));
    } // retranslateUi
